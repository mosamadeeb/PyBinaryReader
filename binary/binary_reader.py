...
class BinaryReader:
    ...
    def write_str_null(self, string: str, encoding='utf-8') -> None:
        """Writes a whole null-terminated string to the buffer.\n
        Default encoding is UTF-8.
        """
        self.write_bytes(string.encode(encoding) + b'\x00')
